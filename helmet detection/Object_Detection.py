...
def camera():
    ...
    try:
        ...
        while True:
            ...
            cv2.imshow("GROUP 13", img)
            if stop or cv2.waitKey(1)==27:
                break
    except:
        tk.messagebox.showerror(title="GROUP 13", message="Camera not found or it's look like other app using camera.\nPlease plug in camer or close other app.")
...
def about():     
    ...
    about_title = tk.Label(about_win,text="GROUP 13\n")
